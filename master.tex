...
coursework=Object-Oriented Programming{,} Data Structures \& Algorithms{,} Discrete Math{,} Matrix Algebra,
...
%		\item Improved the GNOME Clocks user experience by fixing various reported bugs.
		\item Fixed bug causing GNOME Clocks timers to not progress during system suspend by reworking the timer logic.
		\item Added functionality to world clock to show country and state in case two cities have the same name.
