...
%		\item Improved the GNOME Clocks user experience by fixing various reported bugs.
		\item Fixed bug causing GNOME Cloks timers to not progress during system suspend.
...
%    \end{itemize}
    ...
    \begin{itemize}
        \vspace{-0.5em}
        \itemsep -6pt {}
        \item Conducted \href{https://dl.acm.org/doi/10.1145/3565287.3617613}{\textbf{original research} \faExternalLink} in team of 2 about using Wi-Fi CSI for hand gesture recognition on smartphones.
