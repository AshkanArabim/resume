...
%		\item Used \textbf{PyTorch} to reconstruct state-of-the-art networks proposed in papers.
		...
		\item Built \href{https://github.com/AshkanArabim/accent-change-paper-implementation}{\underline{accent-changer model \faExternalLink}} model using HuggingFace pretrained AI/ML to change foreign English accents to native.
