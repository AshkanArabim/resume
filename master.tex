...
skills=Linux{,} TensorFlow{,} git{,} React.JS{,} Conda{,} Microsoft Office{,} Singularity{,} Webpack,
...
\begin{workSection}{Academic \& Group Projects}
    ...
    \begin{itemize}
        \vspace{-0.5em}
        \itemsep -6pt {}
        \item Achieved 96\% phishing email detection accuracy to classify unlabeled emails for user training.
    \end{itemize}
