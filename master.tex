...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		...
		% TODO:
		\item Implemented API contract changes across multiple \textbf{Go} microservices \& \textbf{OpenAPI} schemas supporting a phased migration from legacy to AWS-based customer data systems handling \textbf{6+M requests/week}.
	\end{itemize}
