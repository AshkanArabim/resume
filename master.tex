...
skills=Python{,} HTML/CSS{,} JavaScript{,} Java{,} Bash{,} LaTeX{,} C++
]
\\
\skillItem[
category=Frameworks \& Software,
skills=Linux{,} TensorFlow{,} git{,} ReactJS{,} Conda{,} Singularity
...
\begin{workSection}{Experience}
    ...
    \begin{itemize}
        ...
        \item Obtained >90\% classification accuracy by using techniques such as LR Scheduling (TensorFlow, Keras)
              % \item First place in final presentation
    \end{itemize}
...
\begin{workSection}{Personal Projects}
    ...
    \customItem[
        ...
        keyHighlight=Coded C++ solutions to 11 of 25 Advent of Code 2022 challenges.
    ]
    \begin{itemize}
        \vspace{-0.5em}
        \itemsep -6pt {}
