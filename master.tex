...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		\vspace{-0.5em}
		\itemsep -6pt {}
		% plan b - based on birds-eye project description
	...
	% 	\item Provisioned \textbf{Docker Swarm} distributed system to stream hardware information from \textbf{8+} compute nodes into one dashboard.
	...
	\begin{itemize}
		...
		\item Contributed to GNOME Clocks; \textbf{used by 40+ million} to track  time. % number of ubuntu users, pulled from wikipedia
		\item Added 
		% features such as 
...
%         \item Developed CNN architecture to classify 5 gestures from 4 people in 6 scenarios using \textbf{Keras} with \textbf{>90\% accuracy}. %(TensorFlow, Python, Bash)
...
\begin{workSection}{Projects}
	...
	\begin{itemize}
		...
		% \item Created DevOps \textbf{CI/CD} script to immediately deploy new releases.
	...
	\begin{itemize}
		...
		\item Increased access to diverse news by creating an AI RSS news translator \& orator with \textbf{55 GitHub stars}.
		\item Implemented a micro service architecture using \textbf{Docker Compose}, for future load-balancing \& increased capacity.
...
\skills{
	...
	%Adobe Illustrator{,} 
	% nah: -----------------------
	% SSH{,} Singularity{,} Webpack {,} Jupyter, Node.js
	% DON'T INCLUDE:
	% Node.JS, Webpack
	]
	%\\
