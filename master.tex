...
%		\item Set up infrastructure for manufacturing automation by configuring and deploying Docker containers.
		\item Set up infrastructure for \textbf{fab transporter robots} by setting up \textbf{Docker} containers on Unix (Linux and Solaris) servers.
		\item Coordinated with 10+ sysadmins \& stakeholders to configure Oracle databases and internal APIs.
	\end{itemize}
