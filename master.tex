...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		...
		\item Built a \textbf{Golang} microservice, deployed using \textbf{AWS Lambda}, enabling internal services to read and write customer tax withholding data during migration from the legacy FIS Profile database.
		% note: plan b
		\item Wrote \textbf{Grafana K6} load tests simulating Discover user data migration into Capital One's customer DB.
