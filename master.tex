...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		...
		\item Built \textbf{Golang} microservice, deployed to \textbf{AWS Lambda}, \& monitored during 2-week on-call rotation, enabling internal services to read \& write customer tax withholding data during migration from the legacy FIS DB.
