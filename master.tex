...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		...
		% \textbf{61\%}. % note: pulled from the presentation
		\textbf{93\%}. % note: reduction from 4 hours to 15 mins
		...
		\item Migrated monitoring dashboards from \textbf{New Relic} and \textbf{Splunk} to \textbf{Observe}, reducing observability fragmentation.
		% note: project 3:
		...
		\item Created plugin to log card data transformations using \textbf{Java} and \textbf{JUnit} test-driven development, improving audit-readiness.
...
\begin{workSection}{Projects}
	...
	\begin{itemize}
		\vspace{-0.5em}
		\itemsep -6pt {}
		\item Created Google Docs back-end clone in \textbf{Go}, capable of handling real-time edits by multiple users on the same document.
	\end{itemize}
