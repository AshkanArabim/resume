...
coursework=Discrete Structures{,} Data Structures{,} Matrix Algebra{,} Computer Architecture{,} Statistics,
% 
]
}
...
% for data science / ML:
skills=Linux{,} Numpy{,} Pandas{,} TensorFlow{,} git{,} React.JS{,} Conda{,} Docker{,} Webpack{,} Microsoft Office,
% for SWE:
% skills=Linux{,} git{,} React.JS{,} Conda{,} Numpy{,} Pandas{,} Webpack
% Other stuff:
% skills=Adobe Photoshop{,} Adobe Illustrator{,},
% meh:
% Django {,} Microsoft Office {,} SSH{,} Singularity{,} Webpack {,} Jupyter
]
\\
\skillItem[
...
\begin{workSection}{Personal Projects}
    ...
    \end{itemize}
%     \customItem[
%     title=\href{https://github.com/AshkanArabim/tic-tac-toe}{Tic Tac Toe Webapp \faExternalLink},
%     duration=Fall 2022,
