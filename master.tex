...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		...
		\item Added \textbf{OpenTelemetry} logging support across team \textbf{Golang} services using Otelslog, cutting logging costs by \textbf{79\%} by migrating from Splunk to Observe and improving incident response through log correlation.
...
\begin{workSection}{Projects}
	...
	\begin{itemize}
		...
		\item Created \textbf{Pebble}-backed operation log w/ periodic snapshots to cap operation replay time.
		% note: some plan b here ^
