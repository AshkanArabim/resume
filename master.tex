...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		...
		\item Added \textbf{OpenTelemetry} logging support across team \textbf{Golang} services using Otelslog, cutting logging costs by \textbf{68\%} by migrating from Splunk to Observe and improving incident response through log correlation.
