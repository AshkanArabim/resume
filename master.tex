...
%    	\item Encouraged participation in open-source projects through workshops, info sessions, competitions, and social events.
		...
		% \item Led team of 6 officers to host biweekly workshops on git, Linux, Vim, Kubernetes, open-source software development, and more.
    \end{itemize}
...
\begin{workSection}{Projects}
	...
	\customItem[
		...
		duration=Team of 4 | September 2024 - present,
	]
	\begin{itemize}
		\vspace{-0.5em}
		\itemsep -6pt {}
		...
		\item Implemented a microservice architecture using \textbf{Docker Compose}, for components to scale independently.
...
%		\item Developed app that takes RSS news feeds (from any source in any language), translates \& summarizes top stories, and plays the summary back like a news briefing podcast.
	...
	duration=Team of 4 | November 2024 - present,
	]
	\begin{itemize}
		\vspace{-0.5em}
		\itemsep -6pt {}
	...
	\customItem[
	title=\href{https://devpost.com/software/vocowbulary-courses}{Vocabulary Courses - HackWesTX 2024 \faExternalLink},
	duration=Team of 4 | September 2024,
	]
	\begin{itemize}
		\vspace{-0.5em}
