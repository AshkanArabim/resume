...
%	\item Contributed to the development of GNOME Clocks, an \textbf{app used by thousands of Linux users} to keep track of time.
	...
	\item Added features such as full-screen timers and timer editing using \textbf{Vala} bindings and \textbf{GTK} components \href{https://youtu.be/fDzYWusOLow}{(\underline{link to video demo \faExternalLink})}. % (in progress)
...
\begin{workSection}{Projects}
	...
	\customItem[
	title=\href{https://devpost.com/software/vocowbulary-courses}{Vocowbulary Courses (HackWesTX 2024 submission) \faExternalLink},
	duration=September 2024,
	]
	\begin{itemize}
		\vspace{-0.5em}
		\itemsep -6pt {}
		\item Built web-app to help non-native speakers practice their pronunciation using spaced repetition. (team of 4, 24 hours)
