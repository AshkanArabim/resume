...
\begin{workSection}{Experience}
	...
	\begin{itemize}
		...
		\item Built a \textbf{Golang} microservice enabling internal services to read and write customer tax withholding data during migration from the legacy FIS Profile database.
		% note: plan b
