...
%		\item Used \textbf{PyTorch} to reconstruct state-of-the-art networks proposed in papers.
		 \item Developed an \href{https://github.com/AshkanArabim/accent-change-paper-implementation}{\textbf{accent-changer model} \faExternalLink} able to convert foreign English accents to native using \textbf{HuggingFace} pretrained AI/ML models through their \textbf{Python} API.
...
\begin{workSection}{Projects}
	...
	\begin{itemize}
			\vspace{-0.5em}
			\itemsep -6pt {}
			\item Created a chat app that uses OpenAI's API to add a flirting tone to all messages users send on the platform.
